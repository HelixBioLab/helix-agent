#!/usr/bin/env python3
"""Apply reviewed F4 content to the exact F3 Word revision; write a new DOCX."""
import argparse
import copy
import hashlib
import json
...
EXPECTED = '0eb83e571276d6069ba3e81265f799eb2d2558fbb3245d753187a23b45e7d962'
...
def main():
    ...
    content = json.loads((ROOT/'docs/tesis/fase4-documento.json').read_text())
    ...
    print(json.dumps({'output':str(args.output),'sha256':hashlib.sha256(args.output.read_bytes()).hexdigest(),'phase':'F4'},indent=2))
