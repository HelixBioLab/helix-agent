#!/usr/bin/env python3
"""Apply reviewed F5 content to the exact F4 Word revision; write a new DOCX."""
import argparse
import copy
import hashlib
import json
...
EXPECTED = '665f31e3542afd20a1aa388ec8857e95de419ac39b048be89e1162b448ea9ce4'
...
def main():
    ...
    content = json.loads((ROOT/'docs/tesis/fase5-documento.json').read_text())
    ...
    print(json.dumps({'output':str(args.output),'sha256':hashlib.sha256(args.output.read_bytes()).hexdigest(),'phase':'F5'},indent=2))
