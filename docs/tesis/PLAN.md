...
## Avance F4 y cierre de ingeniería R3.2
...
**H4.2/R3.2 queda implementado y verificado en ingeniería.** El cierre añade cuota XFS privada y límites cgroup v2 del controlador y tareas. Siete contrastes finales posteriores a una corrección reproducen conteos y geometría, con margen mediano 13,54%, cero subestimaciones observadas y cero sobrepasos de cuota. Se conservan los dos fallos de estimación previos. No se cambian los umbrales F2 ni se declara realizada la reserva T-RESOURCE. [Detalle](R3.2-RECURSOS.md).

F5 puede comenzar sus controles estructurales sobre la ruta disponible. Las garantías operativas de recursos de F4 ya se implementaron. Antes de la medición dependiente de F6 se deben cerrar la ampliación del catálogo y los mapeos pendientes de F3, o registrar una enmienda prospectiva justificada que el autor decida. No se eliminan esos compromisos ni se trasladan a trabajos futuros. Anotador, clúster, modelo y presupuesto de evaluación siguen pendientes; la fecha de sustentación permanece en julio de 2027.

## Avance F5 y condiciones para F6

El usuario indicó continuar con F5 aun conservando R3.2 abierto. Se implementaron H5.1–H5.4 en el ámbito mecánico: catálogo de nueve controles, lectura semántica mmCIF, correspondencias y confianza, herramienta del agente y reporte enlazado al contenido aprobado de Nextflow. Se verificaron dos fuentes reales y perturbaciones adversariales, regresión y una ejecución científica real. Véanse [F5-CONTROLES.md](F5-CONTROLES.md) y [las exclusiones de desarrollo](../../evaluation/trp/F5.md).

La compuerta completa del dominio permanece abierta: no hay certificación física ni diagnóstico genómico desde coordenadas aisladas; los constructos requieren interpretación adicional. El paquete público de Pratt contiene 78 filas de metadatos, pero no se recuperaron coordenadas/PAE originales de sus predicciones. R5.4 sigue sin medir. No se reducen sus metas ni se sustituyen los casos publicados por ejemplos sintéticos.

R3.2 se cerró en ingeniería con la segunda PC. Antes de las mediciones dependientes de F6 deben resolverse admisión del instrumental, mapeos, datos originales recuperables y anotaciones independientes. Las opciones se detallan en [DECISIONES-PENDIENTES.md](DECISIONES-PENDIENTES.md). La sustentación sigue prevista para julio de 2027 y el borrador completo para el 4 de junio.
