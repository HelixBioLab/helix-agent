...
export class Service extends Context.Service<Service, Interface>()("@helix/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.HELIX_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
