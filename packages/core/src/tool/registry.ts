...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@helix/llm"
...
export class Service extends Context.Service<Service, Interface>()("@helix/v2/ToolRegistry") {}
