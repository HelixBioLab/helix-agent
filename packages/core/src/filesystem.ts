...
import { Entry, FileSystem, FindInput, Match } from "@helix/schema/filesystem"
export { Entry, Match, Submatch } from "@helix/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@helix/v2/FileSystem") {}
