...
import type { EffectDrizzleSqlite } from "@helix/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@helix/ProjectDirectories") {}
