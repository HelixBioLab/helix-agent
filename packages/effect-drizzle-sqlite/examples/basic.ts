...
class Database extends Context.Service<Database, DatabaseShape>()("@helix/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@helix/example/UserStore") {
