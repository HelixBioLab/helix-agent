...
```ts
import { CodeMode, Tool } from "@helix/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@helix/codemode"
...
const runtime = CodeMode.make({ tools: { helix: api.tools } })
...
```ts
import { toolError } from "@helix/codemode"
