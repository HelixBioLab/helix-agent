...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips helix-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-helix-directory"]).toBeUndefined()
      expect(forwarded["x-helix-workspace"]).toBeUndefined()
