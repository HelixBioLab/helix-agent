...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips helix-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-helix-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-helix-directory")).toBeNull()
      expect(result.get("x-helix-workspace")).toBeNull()
