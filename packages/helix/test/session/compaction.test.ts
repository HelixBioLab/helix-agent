...
import { LLMEvent, Usage } from "@helix/llm"
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      if (last?.parts[0]?.type === "text") {
        ...
        // Compaction fires mid-task. The prompt must not hand the model a licence to
        // stop at the moment it just lost its context — if it cannot proceed
        // it has to say what it did, what remains, and what it needs.
        expect(text).not.toContain("or stop and ask for clarification")
