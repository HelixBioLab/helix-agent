...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders HELIX_CALLER", () => {
    process.env["HELIX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode HELIX_CALLER", () => {
    process.env["HELIX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown HELIX_CALLER", () => {
    process.env["HELIX_CALLER"] = "unknown"
