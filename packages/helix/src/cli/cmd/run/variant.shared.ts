...
//
// The saved variant persists across sessions in ~/.local/state/helix/model.json
...
class Service extends Context.Service<Service, VariantService>()("@helix/RunVariant") {}
