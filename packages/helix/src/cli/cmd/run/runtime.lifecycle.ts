...
import { openEditor } from "@helix/tui/editor"
import { registerHelixKeymap } from "@helix/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerHelixKeymap(keymap, renderer, input.tuiConfig)
