...
import { MAX_STEPS_PROMPT } from "@helix/core/session/runner/max-steps"
...
import { LLMEvent } from "@helix/llm"
...
export class Service extends Context.Service<Service, Interface>()("@helix/SessionPrompt") {}
      ...
      function* (sessionID: SessionID) {
        ...
        while (true) {
          ...
          const outcome: "break" | "continue" = yield* Effect.gen(function* () {
            ...
            const [persona, skills, env, instructions, mcpInstructions, modelMsgs] = yield* Effect.all([
              sys.persona(),
              sys.skills(agent),
            ...
            if (finished && !handle.message.error) {
              ...
              // A truncated response is not a finished turn. `length` means the model
              // was cut off mid-sentence by the output cap; treating it as a clean
              // finish is why long turns ended silently with no error.
