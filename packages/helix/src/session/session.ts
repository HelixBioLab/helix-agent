...
import { locationServiceMapLayer } from "@helix/core/location-services"
...
import { PartTable, SessionTable } from "@helix/core/session/sql"
...
import { NonNegativeInt, optional } from "@helix/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".helix", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@helix/Session") {}
