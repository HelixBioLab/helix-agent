import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@helix/llm"
...
// Move this extraction into @helix/llm when Copilot is handled by the native runtime.
