import type { JsonSchema, LLMRequest, ProviderMetadata } from "@helix/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@helix/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @helix/llm request objects from helix's session/AI SDK-shaped data.
  return LLM.request({
