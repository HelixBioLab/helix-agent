import type { Hooks, PluginInput } from "@helix/plugin"
import type { Model } from "@helix/sdk/v2"
import { InstallationVersion } from "@helix/core/installation/version"
import { OauthCallbackPage } from "@helix/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Helix will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
