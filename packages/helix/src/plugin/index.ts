...
import { createHelixClient } from "@helix/sdk"
...
import { InstallationChannel } from "@helix/core/installation/version"
...
export class Service extends Context.Service<Service, Interface>()("@helix/Plugin") {}
...
function internalPlugins(flags: RuntimeFlags.Info): PluginInstance[] {
  return [
    ...
    CopilotAuthPlugin,
    // These third-party plugins type against the published @opencode-ai/plugin
    // package; the API is structurally identical to @helix/plugin at runtime.
