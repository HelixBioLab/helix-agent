...
import { ConfigMCPV1 } from "@helix/core/v1/config/mcp"
...
import { McpEvent } from "@helix/schema/mcp-event"
import { McpBrowser } from "./browser"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/HelixBioLab/helix-agent/issues/11948
    // sampling: {},
    // https://github.com/HelixBioLab/helix-agent/issues/23066
    // elicitation: {},
    // https://github.com/HelixBioLab/helix-agent/issues/2308
    roots: {},
    // https://github.com/HelixBioLab/helix-agent/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "helix", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@helix/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: helix mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
