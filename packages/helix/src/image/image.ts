...
export class Service extends Context.Service<Service, Interface>()("@helix/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __HELIX_PHOTON_WASM_PATH?: string }).__HELIX_PHOTON_WASM_PATH =
