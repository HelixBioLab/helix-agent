...
export class Service extends Context.Service<Service, Interface>()("@helix/SessionShare") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const share = Effect.fn("SessionShare.share")(function* (sessionID: SessionID) {
      // Sharing requires a hosted share backend, which this build does not ship.
      throw new Error("Sharing is disabled in this build")
    })
