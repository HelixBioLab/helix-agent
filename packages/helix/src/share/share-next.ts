...
import type * as SDK from "@helix/sdk/v2"
...
import { SessionShareTable } from "@helix/core/share/sql"
import { ProviderV2 } from "@helix/core/provider"
import { ModelV2 } from "@helix/core/model"
import { EventV2 } from "@helix/core/event"

// Session sharing relied on an upstream hosted service; it is permanently
// disabled in this build until a self-hosted share backend is configured.
const disabled = true
...
export class Service extends Context.Service<Service, Interface>()("@helix/ShareNext") {}
