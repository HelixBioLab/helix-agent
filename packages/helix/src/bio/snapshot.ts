...
//
// Data lands in a VISIBLE project folder, not in `.helix/`: a corpus is the
// scientist's working content. Only agent bookkeeping belongs in `.helix/`.
...
export class Service extends Context.Service<Service, Interface>()("@helix/BioSnapshot") {}
