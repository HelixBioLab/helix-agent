...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@helix/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@helix/ACPDirectory") {}
