...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@helix/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.helix || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@helix/ToolRegistry") {}
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        return {
          ...
          // tool. An unrelated MCP tool is user configuration, not part of Helix's
