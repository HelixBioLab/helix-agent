...
// Helix runs a critique shaped to the KIND of analysis — not a fixed checklist — and
...
// invalid as configured (e.g. too few replicates to test), Helix pauses and requires
...
// What Helix knows about how the analysis was configured. All optional — the agent
