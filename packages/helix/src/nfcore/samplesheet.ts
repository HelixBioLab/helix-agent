...
// `assets/schema_input.json` (an nf-schema JSON Schema for the rows). Helix reads
...
export class Service extends Context.Service<Service, Interface>()("@helix/NfcoreSamplesheet") {}
