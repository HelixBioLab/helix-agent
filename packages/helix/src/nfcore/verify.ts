...
// reviewer, or a CI job can run it without running Helix's brain. Anything that needed a
...
export class Service extends Context.Service<Service, Interface>()("@helix/NfcoreVerify") {}
