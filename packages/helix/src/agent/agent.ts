...
import { AbsolutePath, type DeepMutable } from "@helix/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@helix/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".helix", "plans", "*.md")]: "allow",
