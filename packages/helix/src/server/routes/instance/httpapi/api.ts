...
import { makeApi } from "@helix/protocol/api"
import { LocationMiddleware } from "@helix/server/location"
import { SessionLocationMiddleware } from "@helix/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("helix-root")
...
export const InstanceHttpApi = HttpApi.make("helix-instance")
...
export const HelixHttpApi = HttpApi.make("helix")
