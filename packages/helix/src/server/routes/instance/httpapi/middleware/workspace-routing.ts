...
>()("@helix/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@helix/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.HELIX_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.HELIX_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-helix-directory"] || process.cwd()
}
