...
import { EventSequenceTable, EventTable } from "@helix/core/event/sql"
...
import { WorkspaceEvent } from "@helix/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@helix/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        HELIX_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        HELIX_WORKSPACE_ID: config.id,
        HELIX_EXPERIMENTAL_WORKSPACES: "true",
