 ...
 *   "@helix/ServerAuthConfig",
 *   {
 *     password: Config.string("HELIX_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("HELIX_SERVER_USERNAME").pipe(Config.withDefault("helix")),
 *   },
 * ) {}
 *
