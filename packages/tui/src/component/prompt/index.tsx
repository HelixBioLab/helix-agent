...
import { registerHelixSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@helix/sdk/v2"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.HELIX_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
