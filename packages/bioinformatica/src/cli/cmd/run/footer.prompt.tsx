...
import { normalizePromptContent } from "@bioinformatica/tui/editor"
...
import { BIOINFORMATICA_BASE_MODE, useBindings } from "@bioinformatica/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Helix Agent" } satisfies SlashOption,
    ]
