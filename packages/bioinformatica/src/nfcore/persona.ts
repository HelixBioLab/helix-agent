...
export const BuiltinSkills: readonly BuiltinSkill[] = [
  ...
  },
  {
    name: "nfcore-fork",
    description:
      "How Helix Agent forks a pipeline for local code changes: cloning it into a visible pipelines/<name>-fork/ folder pinned to one upstream release, recording provenance in .bioinformatica/ via nfcore_fork, keeping it conformant with nfcore_lint, and tracking exactly how it diverged from upstream with nfcore_fork_status. Load this when a scientist needs to modify a pipeline's code rather than just its parameters.",
    content: SKILL_FORK,
  },
  {
